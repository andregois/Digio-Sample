...
class MainViewModelTest {
    ...
    fun `when view model fetchData get error then sets response`() = runBlocking {
        whenever(digioDataSource.getDigioData()).thenThrow(RuntimeException(""))
...
private fun createDigioResponse(): DigioResponse {
    return DigioResponse(
        ...
        listOf(
            Product(
                "Com o e-Gift Card Level Up você adquire créditos para jogar diversas opções de games, de MMORPGs a jogos de Tiro e Mobas! Para ver a lista de jogos e a quantia de créditos que pode resgatar em cada um deles, acesse: http://levelupgames.uol.com.br/levelup/seuegiftcard.lhtml",
